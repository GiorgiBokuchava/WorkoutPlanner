...
-- Sanity-check output
PRINT 'Seed complete — current data:';
SELECT * FROM [Identity].Users;
SELECT * FROM [Identity].Routines;
SELECT * FROM [Identity].WorkoutLogs;
SELECT * FROM [Workout].Exercises;
SELECT * FROM [Workout].RoutineExercises;
SELECT * FROM [Workout].WorkoutExercises;
GO